...
$$._HashMapImpl = {"":"Object;_keys>,_values,_loadLimit,_numberOfEntries,_numberOfDeleted",
          ...
          switch (state0) {
            ...
            case 3:
              ...
              if (existingKey == null) {
                ...
                return hash;
              else if ($.ltB(insertionIndex, 0) && existingKey === $.CONSTANT2)
                insertionIndex = hash;
              numberOfProbes0 = numberOfProbes + 1;
              t1 = this._keys;
              hash = $._HashMapImpl__nextProbe(hash, numberOfProbes, $.getInterceptor$JSStringJSArray(t1).get$length(t1));
 ...
 operator$indexSet$2: function(key, value) {
  ...
  if ($.index(this._keys, index) == null || $.index(this._keys, index) === $.CONSTANT2)
 ...
 remove$1: function(key) {
  ...
  if ($.geB(index, 0)) {
    ...
    $.indexSet(this._keys, index, $.CONSTANT2);
...
$$.FixedSizeListIterator = {"":"_VariableSizeListIterator;_liblib2$_length,_array,_pos",
 get$hasNext: function() {
...
$$.PropertyGrid = {"":"Object;elementClient,elementBase>,grid>,elementGridWrapper,elementDescription,_model,itemControllers,_selectedPropertyItem",
 ...
 _bindModel$0: function() {
  var t1, itemsByCategory, t2, t3, t4, categoryElement, categoryItems;
  t1 = this.itemControllers;
  $.CONSTANT0.forEach$1(t1, new $.PropertyGrid__bindModel_anon());
  ...
  for (t1 = itemsByCategory.get$keys(), t1 = $.getInterceptor$JSArray(t1).iterator$0(t1); t1.get$hasNext() === true;) {
    t2 = t1.next$0();
 ...
 _bindModel$0$bailout: function(state0, itemsByCategory) {
  var t1, t2, t3, t4, categoryElement, categoryItems;
  for (t1 = this._model.get$items(), t1 = $.getInterceptor$JSArray(t1).iterator$0(t1); t1.get$hasNext() === true;) {
    t2 = t1.next$0();
    if (itemsByCategory.containsKey$1(t2.get$category()) !== true) {
      t3 = t2.get$category();
 ...
 _insertCategoryElement$1: function(category) {
  ...
  $.getInterceptor$JSArray(t1).add$1(t1, new $.PropertyGrid__insertCategoryElement_anon(categoryItemBody, "property-grid-icon-plus", "property-grid-icon-minus", expandIcon));
...
$$.PropertyGridModel = {"":"Object;items>",
 register$8$category$description$editorConfig: function(name$, getter, setter, viewType, editorType, category, description, editorConfig) {
  var item = $.PropertyItem$(name$, getter, setter, viewType, editorType, category, description, editorConfig);
...
$$.PropertyEditorColor = {"":"PropertyItemEditorBase;elementEditor,elementEditorInnerWrapper,editing>,colorPicker>,controller",
 showEditor$0: function() {
  var t1, cell, t2, left, top$, initialColor;
  t1 = this.controller;
  ...
  $.getInterceptor$JSArray(t2).add$1(t2, new $.PropertyEditorColor_showEditor_anon(this));
  t2 = this.elementEditor.get$on().get$keyDown();
  $.getInterceptor$JSArray(t2).add$1(t2, new $.PropertyEditorColor_showEditor_anon0(this));
  t2 = new $.PropertyEditorColor_showEditor_anon1(this);
  this.colorPicker.set$colorChangeListener(t2);
  this.editing = true;
},
...
$$.PropertyEditorSlider = {"":"PropertyItemEditorBase;elementEditor,slider>,editing>,controller",
 showEditor$0: function() {
 ...
 _notifyFinishEditing$0: function() {
  if (this.editing)
    this.controller.finishEditing$1(this.slider.get$value());
},
 dispose$0: function() {
  this.editing = false;
},
 PropertyEditorSlider$1: function(controller) {
  ...
  if (!(sliderConfig == null)) {
    ...
    t1 = false;
  if (t1)
    if ($.geB($.getInterceptor$JSStringJSArray(sliderConfig).get$length(sliderConfig), 2)) {
      minValue = $.index(sliderConfig, 0);
      maxValue = $.index(sliderConfig, 1);
      t1 = $.getInterceptor(minValue).toString$0(minValue);
      this.slider.set$min(t1);
      t1 = $.getInterceptor(maxValue).toString$0(maxValue);
      this.slider.set$max(t1);
    }
  this.elementEditor = $.DivElement_DivElement();
  t1 = this.elementEditor.get$nodes();
...
$$.HsvGradientPicker = {"":"Object;hue>,chroma,saturation>,value=,_color>,hueColor,cursorRadius,colorChangeListener<,canvas>,context,buffer,_cursorX,_cursorY,mouseListener",
 ...
 _rebuildGradient$0: function() {
  var height, width, intensityDelta, t3, _buffer, t1, index, h, intensity, greyScaleComponent, startColor, endColor, pixelIntensity, w, pixelColor, index0, t2;
  ...
  for (t1 = height - 1, index = 0, h = 0; h < height; ++h) {
    ...
    if (typeof endColor !== 'number')
      return this._rebuildGradient$0$bailout(3, intensityDelta, index, h, _buffer, startColor, height, endColor, width);
 ...
 _rebuildGradient$0$bailout: function(state0, env0, env1, env2, env3, env4, env5, env6, env7) {
  ...
  switch (state0) {
    ...
    case 2:
      ...
      h = 0;
    case 3:
      var height, width, t3, intensityDelta, _buffer, index, h, intensity, greyScaleComponent, startColor, endColor, pixelIntensity, w, pixelColor, index0, t1, t2;
      L0:
        while (true)
          switch (state0) {
            case 0:
...
$$.HueSlider = {"":"Object;hueChangelistener<,canvas>,_hueAngle,mouseListener,gradient",
 ...
 _buildGradient$0: function() {
  ...
  t1 = $.CONSTANT0.get$last(hueColors);
...
$$.PropertyEditorSlider_showEditor_anon = {"":"Closure;this_0",
 call$1: function(e) {
  var t1 = this.this_0;
  if (t1.get$editing() === true)
    t1.get$controller().finishEditing$1(t1.get$slider().get$value());
  return;
}
};
...
$$.PropertyEditorSlider_showEditor_anon1 = {"":"Closure;this_2",
 call$1: function(e) {
  var t1 = this.this_2;
  return t1.get$controller().requestValueChange$1(t1.get$slider().get$value());
}
};
...
$$.PropertyGrid__insertCategoryElement_anon = {"":"Closure;categoryItemBody_0,cssIconPlus_1,cssIconMinus_2,expandIcon_3",
 call$1: function(e) {
  var t1, t2, t3, t4, t5, t6;
  t1 = this.categoryItemBody_0;
  t2 = t1.get$classes();
  t3 = $.getInterceptor$JSStringJSArray(t2).contains$1(t2, "property-grid-category-body-hide") === true;
  t4 = this.expandIcon_3;
  t5 = this.cssIconPlus_1;
  t6 = this.cssIconMinus_2;
  if (t3) {
...
$.PropertyGrid$ = function(elementClient) {
  ...
  t1 = new $.PropertyGrid(elementClient, null, null, null, null, null, t1, null);
...
$.main = function() {
  $.PropertyGrid$($.query("#my_property_grid")).set$model($._createModel());
};
...
$.PropertyGridModel$ = function() {
  var t1 = $.List_List(null, $.PropertyItem);
  $.setRuntimeTypeInfo(t1, [$.PropertyItem]);
  return new $.PropertyGridModel(t1);
};
...
$.PropertyEditorSlider$ = function(controller) {
  var t1 = new $.PropertyEditorSlider(null, null, false, controller);
